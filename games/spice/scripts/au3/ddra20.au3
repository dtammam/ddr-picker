...
Run('powershell.exe -WindowStyle Hidden -File "C:\Pegasus\scripts\SetMarquee.ps1" -Image "C:\ddr-picker-assets\ddr-picker\assets\ddr-a20.png"', "", @SW_HIDE)

; Launch the game of choice with the correct working directory.
FileChangeDir("C:\Games\MDX-001-2020020300\contents")
Run('C:\Games\MDX-001-2020020300\contents\spice.exe', "")