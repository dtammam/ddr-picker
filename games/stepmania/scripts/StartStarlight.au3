...
Run('powershell.exe -WindowStyle Hidden -File "C:\Pegasus\scripts\SetMarquee.ps1" -Image "C:\ddr-picker-assets\ddr-picker\assets\starlight.png"', "", @SW_HIDE)

; Launch the game of choice with the correct working directory.
FileChangeDir("C:\Games\StepMania 5.3 Outfox STARLiGHT TWOpointZERO\Program")
Run('C:\Games\StepMania 5.3 Outfox STARLiGHT TWOpointZERO\Program\StepMania.exe', "")