...
;~ 		2024-08-10 - Update with reference to asset for digital marquee.e
...
$FileAndROM = '"C:\pegasus\scripts\StartMAME.ps1" "dsftkd -state o"'

; Set the dynamic marquee of choice with the correct working directory.
FileChangeDir("C:\ddr-picker-assets\ddr-picker\assets")
Run('powershell.exe -WindowStyle Hidden -File "C:\Pegasus\scripts\SetMarquee.ps1" -Image "C:\ddr-picker-assets\ddr-picker\assets\dstkd.png"', "", @SW_HIDE)
