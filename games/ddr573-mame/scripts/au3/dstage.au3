...
$FileAndROM = '"C:\pegasus\scripts\StartMAME.ps1" "dstage -state o"'

; Set the dynamic marquee of choice with the correct working directory.
FileChangeDir("C:\ddr-picker-assets\ddr-picker\assets")
Run('powershell.exe -WindowStyle Hidden -File "C:\Pegasus\scripts\SetMarquee.ps1" -Image "C:\ddr-picker-assets\ddr-picker\assets\dstage-ir.png"', "", @SW_HIDE)
