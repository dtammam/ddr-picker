...
While True
	If $Pressed Then
		...
		RunWait('powershell.exe -WindowStyle Hidden -File "' & $File & '" -ExecutableFullPath "C:\Program Files\Microsoft VS Code\Code.exe"', "", @SW_HIDE)
		Sleep(123)
		$Pressed = Not $Pressed
	EndIf
	; Nothing!
