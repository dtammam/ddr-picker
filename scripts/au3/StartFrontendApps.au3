...
Run('powershell.exe -WindowStyle Hidden -File "C:\Pegasus\scripts\SetITGManiaSongBanner.ps1" -FullFilePath "C:\Games\ITGmania\Save\CurrentSongInfo.log"  -FallbackBannerPath = "C:\pegasus\assets\simply-love.png"', "", @SW_HIDE)
