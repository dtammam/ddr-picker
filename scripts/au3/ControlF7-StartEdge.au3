...
While True
	If $Pressed Then
		...
		RunWait('powershell.exe -WindowStyle Hidden -File "' & $File & '" -ExecutableFullPath "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe"', "", @SW_HIDE)
		$Pressed = Not $Pressed
	EndIf
	; Nothing!
	Tooltip("")
